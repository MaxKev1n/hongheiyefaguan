...
#include "../../newproject/savedialog.h"
...
QT_MOC_LITERAL(3, 15, 6), // "choose"
QT_MOC_LITERAL(4, 22, 16) // "QListWidgetItem*"

    },
    "savedialog\0OK\0\0choose\0QListWidgetItem*"
};
...
void savedialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OK((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (savedialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&savedialog::OK)) {
                *result = 0;
                return;
            }
        }
